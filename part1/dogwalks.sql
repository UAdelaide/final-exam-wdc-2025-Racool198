...
((SELECT dog_id FROM Dogs WHERE name = "Finn"), "2025-06-8 08:00:00", "30", "Klemzig", "completed"),
((SELECT dog_id FROM Dogs WHERE name = "Cat"), "2025-06-11 08:00:00", "30", "Greenpath", "cancelled");