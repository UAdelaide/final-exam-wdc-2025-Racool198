...
((SELECT dog_id FROM Dogs WHERE name = "Max"), "2025-06-9 08:00:00", "30", "Parklands", "open"),
((SELECT dog_id FROM Dogs WHERE name = "Max"), "2025-06-8 08:00:00", "30", "Parklands", "open"),
((SELECT dog_id FROM Dogs WHERE name = "Max"), "2025-06-11 08:00:00", "30", "Parklands", "open");